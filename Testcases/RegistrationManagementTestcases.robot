...
Testcase 30: Als student mijn inschrijvingen bekijken
    ...
    # Na het uitvoeren is de huidige pagina opnieuw de "Mijn inschrijvingen" pagina.
    # ------------------------------------------------------------------------------------------------------------
...
Testcase 31: Als student uitschrijven voor een opdracht
    ...
    # Op het moment van het uitvoeren van de testcase moet het systeem op de "Mijn inschrijvingen" pagina zijn. 
    # Na het uitvoeren is de huidige pagina opnieuw de "Mijn inschrijvingen" pagina.
    # ---------------------------------------------------------------------------------------------------------
